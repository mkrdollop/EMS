		...
		<div className="main-wrapper main-wrapper-1">
			...
			<div className="main-content">
            	<section className="section">
					<Link to="/privacypage">
					<h4 className="border-bottom pb-2 mb-4 text-dark">Privacy And Policy</h4>
					</Link>
							...
							<div className="col-12 col-md-10 col-lg-8 mx-auto">
								<div className="card">
									<form className="needs-validation" name="" id="plan" novalidate="">
										...
										<Link to="/addprivacy"><button type="submit" className="btn btn-primary" id="submitBtn">Add Contains</button></Link>
										</div>
									</form>
								</div>
							</div>
